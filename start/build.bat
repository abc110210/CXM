...
set SRC=src\shared.cpp src\report.cpp src\worker.cpp
set CFLAGS=/nologo /std:c++17 /utf-8 /EHsc /O2 /W3 /GS /Gy /D_UNICODE /DUNICODE /DWIN32 /D_WINDOWS
...
copy /Y DiskStress.ini out\DiskStress.ini >nul
